...
<link rel="stylesheet" href="public/online.css?v=550">
...
guest = {gid: ' . $gid . ', fn: "' . $fn . '", aid: 0, au: 0, an: "", sess: "", lang: ' . IS_CHINESE . ', agent: "' . $agent . '", fromurl: "' . $fromurl . '"},
...
<script type="text/javascript" src="public/online_free.js?v=550"></script>
</body>
</html>';
