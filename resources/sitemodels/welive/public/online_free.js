...
function welive_verify(){
	welive.ws.send('x=6&a=8&gid=' + guest.gid + '&fn=' + guest.fn + '&au=' + guest.au + '&aid=' + guest.aid + '&l=' + guest.lang + '&k=' + SYSKEY + '&c=' + SYSCODE + '&fr=' +  guest.fromurl.replace(/&/g, "||4||") + '&ag=' + guest.agent + '&mb=0');
}
