...
class c_messages extends Admin{
	...
	public function index(){
		...
		echo '<tr class="tr0"><td class=td>ID</td><td class=td>发送人</td><td class=td>接收人</td><td class="td" width="60%">对话内容</td><td class=td>记录时间</td><td class="td last"><input type="checkbox" id="checkAll" for="deletemids[]"> <label for="checkAll">删除</label></td></tr>';
