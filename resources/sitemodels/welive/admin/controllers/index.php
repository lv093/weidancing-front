...
class c_index extends Admin{
    ...
    function index($path){
		...
		TableRow('<font class=grey>1)</font>&nbsp;&nbsp;将代码 <span class=note>&lt;script type="text/javascript" charset="UTF-8" src="' . BASEURL . 'welive.js"&gt;&lt;/script&gt;</span> 插入需要调用WeLive客服小面板的网页&lt;html&gt;内.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp此方式将在当前页面打开对话窗口, 支持web及移动端页面. ');

		TableRow('<font class=grey>2)</font>&nbsp;&nbsp;将代码 <span class=note>&lt;script type="text/javascript" charset="UTF-8" src="' . BASEURL . 'welive_ol.js"&gt;&lt;/script&gt;</span> 插入需要在新窗口打开WeLive客服对话窗口的网页&lt;html&gt;内.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp编辑此页面中的元素，为其添加样式：class="welive_online"，那么点击此元素将在新窗口中打开WeLive对话窗口，如：<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&lt;a href="" class="welive_online"&gt;点击在新窗口打开WeLive&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp此方式支持web或移动端页面. ');

		TableRow('<font class=grey>3)</font>&nbsp;&nbsp;客服窗口中, 按 Ctrl + Alt, 在客服交流区与当前客人小窗口间切换.');
		TableRow('<font class=grey>4)</font>&nbsp;&nbsp;客服窗口中, 按 Ctrl + 下箭头 或 Esc键, 关闭当前客人小窗口. 如果小窗口都关闭了, 自动切换到客服交流区.');
		TableRow('<font class=grey>5)</font>&nbsp;&nbsp;客服窗口中, 按 Ctrl + 上箭头, 展开关闭的客人小窗口.');
		TableRow('<font class=grey>6)</font>&nbsp;&nbsp;客服窗口中, 按 Ctrl + 左或右箭头, 在已展开的客人小窗口间切换.');
		TableRow('<font class=grey>7)</font>&nbsp;&nbsp;客服窗口中, 客人被踢出或禁言后, 刷新页面仍可重新进入客服, 即此两项操作仅作用于当前对话.');
		TableRow('<font class=grey>8)</font>&nbsp;&nbsp;WeLive默认安装后, 前台客服小面板不会自动展开, 即不会进入客服. 如何希望自动展开, 可在系统设置中设置. <span class=note>自动展开会消耗服务器资源</span>');
		TableRow('<font class=grey>9)</font>&nbsp;&nbsp;移动端客服登录地址: <span class=note>' . BASEURL . 'app/</span>, 后台管理及客服登录目录admin或app均可任修改.');
		TableRow('<font class=grey>10)</font>&nbsp;&nbsp;在客服窗口中的客服交流区, 管理员可发送特殊指令: system die --- Socket服务将中断并重启(<span class=note>慎用</span>);&nbsp;&nbsp;all --- 显示所有连接数;&nbsp;&nbsp;admin --- 显示所有客服及其客人数;&nbsp;&nbsp;guest --- 显示客人数;&nbsp;&nbsp;robot --- 显示机器人服务数据');
